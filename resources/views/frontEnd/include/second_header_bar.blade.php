        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-3 col-3 order-1">
                <div class="logo_container">
                    <div class="logo"><marquee><a href="#">Jhot Pot Kena Kata</a></marquee></div>
                </div>
            </div>
                    ...
                    <div class="cart">
                        <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                            <div class="cart_content">
                                    <a href="{{route('showCartTable')}}" class="text-success" style="font-size: 20px;"><i class="fas fa-shopping-cart"></i>Cart Products</a>
                            </div>
                        </div>
                    </div>
                </div>
