...
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            <form action="{{route('prodectInsert')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8" style="margin-top: 15px;">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Submit Your Product Information</h3>
                            </div>
                            <div class="card-body">
                                    <div class="row">
                                        ...
                                        <select class="form-control" name="subcategorie_id" id="subcategorie_id" required>
                                            ...
                                            <option style="color:red" disabled >{{$categorie->categorie_name}}</option>
                                                ...
                                                @foreach ($subcats as $subcat)
                                                    <option value="{{$subcat->id}}">{{$subcat->subcategorie_name}}</option>
                                                @endforeach
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="brand_id" class="form-control" required>
                                            ...
                                            @foreach($brands as $brand)
                                                <option style="color: green" value="{{$brand->id}}">{{$brand->brand_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="sku" value="{{old('sku')}}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                    ...
                    <div class="col-md-4" style="margin-top: 15px;">
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <input type="file" class="form-control dropify" name="thumbnail" required="" accept="image/*"/>
                                </div>
                                <br>
                                <div class="">
                                    <table class="table table-bordered" id="dynamic_field">
                                        <div class="card-header">
                                            <h3 class="card-title">Click For More Image(click add option for more image)</h3>
                                        </div>
                                        <tr>
                        ...
                        <button type="submit" class="btn btn-success col-l-4">Submit</button>
            </form>
        </div>
    </section>
</div>
