...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        ...
        <a href="{{route('AdmIn_logouT')}}" id="logout" style="color: #00FF00">Logout</a>
    </nav>
    <!-- /.navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a class="brand-link" style="font-family: Apple;background-color: #00bb00">
            <img src="{{asset('/')}}admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light"> Jhot Pot Kena Kata</span>
        </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('categorie_table')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Categorie</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('subcategorie_table')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Subcategorie</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('childcategorie_table')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Childcategorie</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('brand_table')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Brand</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('productTable')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                        Create Products
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('coupnForm')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    Coupn
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('campaignTable')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    E-Campain
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('pickupForm')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    Pickup
                                </a>
                            </li>
...
{{-- Front Side Setting Here--}}
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('seo_setup')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        Seo Setting
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="{{route('pageManageTable')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        Page Create
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="{{route('smtp_form')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        SMTP Setting
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="{{route('warehouseForm')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        WareHouse
                                    </p>
...
{{--                    <li class="nav-header"><i class="fas fa-cog"> Setting</i></li>--}}
                    <li class="nav-item">
                        <a href="{{route('password_reset')}}" class="nav-link">
